...
export default function ModalContentDeposit({dataUsers}) {
          ...
          <table className="min-w-full text-sm text-left border-collapse">
            <thead className="sticky top-0 bg-blue-100 text-gray-800 z-10">
              <tr>
                ...
                <th className="px-3 py-2 hidden md:table-cell">Jumlah Deposit</th>
              ...
              {displayUsers.map((user, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-3 py-2 hidden md:table-cell">{user.jmlhDeposit}</td>
                    <td className="px-3 py-2 hidden md:table-cell">{user.statusDeposit}</td>
