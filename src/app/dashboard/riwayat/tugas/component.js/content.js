...
export default function TaskHistory({ dataUsers: initialData = [] }) {
                    ...
                    <div className="overflow-x-auto">
                        <table className="min-w-full text-sm text-left">
                            <thead className="bg-gradient-to-r from-blue-600 to-blue-500 text-white">
                                <tr>
                                    ...
                                    <th className="px-4 py-3 font-semibold hidden md:table-cell">Task ID</th>
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <td className="px-4 py-3 font-semibold text-green-600">
                                                {formatCurrency(task.commission || 0)}
                                            </td>
                                            <td className="px-4 py-3 text-center">
                                                {task.userRating ? (
                                                    <div className="flex items-center justify-center gap-1">
                                                        ...
                                                        <span className="font-medium">{task.userRating}</span>
                                                    </div>
                                                ) : (
                        ...
                        {displayUsers.length === 0 && !isLoading && (
                            <div className="text-center py-12">
                                ...
                                <p className="text-gray-400 text-sm">Belum ada tugas yang selesai</p>
                            </div>
                        )}
                    </div>
