...
export default function RootDashboard({ children }) {
  ...
  // Komponen Sidebar yang bisa digunakan untuk desktop & mobile
    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="lg:hidden fixed top-4 left-4 z-50">
        <button
          ...
          className="bg-white rounded-md shadow-lg p-2.5 text-gray-700 hover:bg-gray-50 transition-colors"
      ...
      {/* Mobile Sidebar */}
      <aside
        className={`lg:hidden fixed top-0 left-0 h-full w-64 bg-white z-40 transform transition-transform duration-300 ease-in-out flex flex-col border-r border-gray-200 ${
